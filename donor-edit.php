            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        if(isset($_GET['id']))
                        {
                            $donor_id_no = mysqli_real_escape_string($con, $_GET['id']);
                            $query = "SELECT * FROM donor WHERE id_no='$donor_id_no' ";
                            ...
                            if(mysqli_num_rows($query_run) > 0)
                            {
                                ...
                                <form action="code.php" method="POST">
                                    <input type="hidden" name="donor_id_no" value="<?= $donor['id_no']; ?>">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="blood_group" value="<?=$donor['blood_group'];?>" class="form-control">
                                    </div>
                                    <div class="mb-3">
                                        <label>Pincode</label>
                                        <input type="text" name="pincode" value="<?=$donor['pincode'];?>" class="form-control">
                                    </div>
                                    <div class="mb-3">
